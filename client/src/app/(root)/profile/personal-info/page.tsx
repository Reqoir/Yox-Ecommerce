  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 pb-5 gap-4">
        ...
        {!isEditing ? (
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-black hover:bg-gray-800 text-white text-xs font-bold rounded-sm transition-colors shadow-2xs self-start sm:self-auto"
          >
            <Edit3 size={14} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-gray-50 border border-gray-200 rounded-sm p-4 flex items-center gap-3">
          <div className="w-10 h-10 rounded-sm bg-black/5 text-black flex items-center justify-center font-bold shrink-0">
            <User size={20} />
          </div>
          <div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-sm p-4 flex items-center gap-3">
          <div className="w-10 h-10 rounded-sm bg-emerald-100 text-emerald-800 flex items-center justify-center font-bold shrink-0">
            <Mail size={20} />
          </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-sm p-4 flex items-center gap-3">
          <div className="w-10 h-10 rounded-sm bg-amber-100 text-amber-800 flex items-center justify-center font-bold shrink-0">
            <Phone size={20} />
          </div>
          <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pt-2">
        <div className="space-y-4 max-w-2xl">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3.5 py-2.5 text-xs text-gray-900 border border-gray-300 rounded-sm bg-white focus:outline-none focus:ring-2 focus:ring-black/20 focus:border-black transition-all disabled:bg-gray-50 disabled:text-gray-600 disabled:cursor-not-allowed"
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-[10px] font-semibold text-amber-700 bg-amber-50 border border-amber-200 px-2 py-0.5 rounded-xs flex items-center gap-1">
            ...
            <input
              ...
              disabled={true}
              className="w-full px-3.5 py-2.5 text-xs text-gray-600 border border-gray-200 rounded-sm bg-gray-100 cursor-not-allowed font-medium"
            />
        ...
        <div className="p-4 bg-gray-50 border border-gray-200 rounded-sm flex items-start gap-3 text-xs text-gray-900 max-w-2xl">
          <ShieldCheck size={18} className="text-black shrink-0 mt-0.5" />
          <div>
            <p className="font-bold text-black">Your Privacy & Data Protection</p>
