...
export const productListQuerySchema = z.object({
  ...
  inStock: z.union([z.boolean(), z.enum(['true', 'false'])]).optional().transform(val => typeof val === 'boolean' ? val : (val === 'true' ? true : (val === 'false' ? false : undefined))),
  onSale: z.union([z.boolean(), z.enum(['true', 'false'])]).optional().transform(val => typeof val === 'boolean' ? val : (val === 'true' ? true : (val === 'false' ? false : undefined))),
  hasDiscount: z.union([z.boolean(), z.enum(['true', 'false'])]).optional().transform(val => typeof val === 'boolean' ? val : (val === 'true' ? true : (val === 'false' ? false : undefined))),
  minRating: z.union([z.string(), z.number()]).optional(),
  isFeatured: z.union([z.boolean(), z.enum(['true', 'false'])]).optional().transform(val => typeof val === 'boolean' ? val : (val === 'true' ? true : (val === 'false' ? false : undefined))),
  isActive: z.union([z.boolean(), z.enum(['true', 'false'])]).optional().transform(val => typeof val === 'boolean' ? val : (val === 'true' ? true : (val === 'false' ? false : undefined))),
